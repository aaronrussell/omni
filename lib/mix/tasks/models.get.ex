defmodule Mix.Tasks.Models.Get do
  ...
  Models that are deprecated or lack tool use support are filtered out. Output is
  ...
  defp transform_model(model) do
    %{
      ...
      "input_modalities" => get_in(model, ["modalities", "input"]) || ["text"],
      "output_modalities" => get_in(model, ["modalities", "output"]) || ["text"],
