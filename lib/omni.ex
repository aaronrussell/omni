defmodule Omni do
  ...
  startup, list provider modules (`:builtins` names all built-ins and may appear
  in the list):
  ...
  ## Options
    ...
    * `:thinking` — enable extended thinking. Pass an effort level
      (`:low`, `:medium`, `:high`, `:xhigh`, `:max`), `%{budget: tokens}`,
      or `false` to disable
