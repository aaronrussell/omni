defmodule Omni.Dialects.OpenAIResponsesIntegrationTest do
  ...
  @thinking_fixture "test/support/fixtures/sse/openai_responses_thinking.sse"
  ...
  describe "thinking streaming pipeline" do
    setup do
      Req.Test.stub(:openai_responses_thinking, fn conn ->
    ...
    test "build_request → Req.request → SSE.stream → parse_event produces thinking and text deltas" do
      ...
      {:ok, resp} =
        req |> Req.merge(plug: {Req.Test, :openai_responses_thinking}) |> Req.request()
